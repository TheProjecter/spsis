			...
			<?php
				if(isset($_REQUEST['tet'])){
					...
					if(mysql_num_rows($result)==0){
						...
						echo "<p>Click on the material # of your chosen Spare Part</p>";
							...
							echo "<table id='users' class='ui-widget ui-widget-content'>";
								...
								echo "<div class='demo'>";
									...
									while($rows2 = mysql_fetch_array($result)){
										...
										echo "<td> <input type='button' class='ui-state-default ui-corner-all' onclick='withraw(" . $rows2['id'] . ");' value='withraw'/> </td>";
										echo "</tr>" ;
										$i++;
									}
								echo "</div>";
