...
function deposit_home(aydi){
	var p = prompt("Enter amount:");
	var disp = parseInt(p);

	window.location="http://localhost/spsis/process/deposit.php?id="+aydi+"&am="+disp;
}

function withdraw_home(aydi){
	var p=prompt("Enter amount:");
	var disp = parseInt(p);

	window.location="http://localhost/spsis/process/withdraw.php?id="+aydi+"&am="+disp;
}
